                    ...
                    <div class="product-cart-wrap mb-30">
                        <div class="product-img-action-wrap">
                            <div class="product-img product-img-zoom">
                                <a href="{{ url('ccategory/'. request()->segment(2). '/'. request()->segment(3). '/'.strtolower($category->fcategory_name). '/'. request()->segment(4)) }}">
                        ...
                        <div class="product-content-wrap">
                            <h2><a href="{{ url('ccategory/'. request()->segment(2). '/'. request()->segment(3). '/'.strtolower($category->fcategory_name). '/'. request()->segment(4)) }}">{{$category->fcategory_name}}</a></h2>
                        </div>
                    </div>
                </div>
                @endforeach

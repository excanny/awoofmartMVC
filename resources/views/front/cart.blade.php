...
<div class="container mb-80 mt-50 mx-5">
    <div class="row">
        <div class="col-lg-8 mb-40">
            <h3 class="heading-2 mb-10">Your Cart</h3>
            <div class="d-flex justify-content-between">
                <h6 class="text-body">There are <span class="text-brand">{{$cart_contents->count()}}</span> products in your cart</h6>
                        ...
                        @foreach ($cart_contents as $product)
                            ...
                            <tr class="pt-30">
                                ...
                                <td class="product-des product-name">
                                    <h6 class="mb-5"><a class="product-name mb-10 text-heading" href="shop-product-right.html">{{$product->fproduct_id}}</a></h6>
                                ...
                                <td class="text-center detail-info" data-title="Stock">
                                    <div class="detail-extralink mr-15">
                                        <div class="detail-qty border radius">
                                            ...
                                            <span class="qty-val">{{$product->fquantity }}</span>

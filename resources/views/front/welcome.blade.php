    ...
    <div class="container">
      <div class="row">
          ...
          <div class="col">
              ...
              <a href="javascript:void" data-toggle="modal" data-target="#authModal">Login/Register</a>
            </div>
              <div class="col">
                  <button data-toggle="modal" data-target="#startShoppingModal">Start Shopping</button>
              </div>
          </div>
      </div>
    </div>

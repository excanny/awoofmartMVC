                            ...
                            <ul>
                                ...
                                {{-- <li>
                                    ...
                                    <ul class="language-dropdown">
                                        <li>
                                            <a href="#"><img src="{{asset('assets1/images/flag-fr.png')}}" alt>Français</a>
                                        </li>
                                        <li>
                                            <a href="#"><img src="{{asset('assets1/images/flag-dt.png')}}" alt>Deutsch</a>
                                        </li>
                                        <li>
                                            <a href="#"><img src="{{asset('assets1/images/flag-ru.png')}}" alt>Pусский</a>
                                        </li>
                                    </ul>
                                </li> --}}
                                {{-- <li>
                                    ...
                                    <ul class="language-dropdown">
                                        <li>
                                            <a href="#"><img src="{{asset('assets1/images/flag-fr.png')}}" alt>INR</a>
                                        </li>
                                        <li>
                                            <a href="#"><img src="{{asset('assets1/images/flag-dt.png')}}" alt>MBP</a>
                                        </li>
                                        <li>
                                            <a href="#"><img src="{{asset('assets1/images/flag-ru.png')}}" alt>EU</a>
                                        </li>
                                    </ul>
                                </li> --}}
                            </ul>
            ...
            <div class="container">
                <div class="header-wrap">
                    <div class="logo logo-width-1">
                        <a href="index.html"><img src="{{asset('assets1/fonts/logo.svg')}}" alt="logo"></a>
                    </div>
                            ...
                            <div class="header-action-2">
                                ...
                                <div class="header-action-icon-2">
                                    <a href="shop-compare.html">
                                        <img class="svgInject" alt="Nest" src="{{asset('assets1/fonts/icon-compare.svg')}}">
                                ...
                                <div class="header-action-icon-2">
                                    <a href="shop-wishlist.html">
                                        <img class="svgInject" alt="Nest" src="{{asset('assets1/fonts/icon-heart.svg')}}">
                                ...
                                <div class="header-action-icon-2">
                                    <a class="mini-cart-icon" href="shop-cart.html">
                                        <img alt="Nest" src="{{asset('assets1/fonts/icon-cart.svg')}}">
                                        ...
                                        <ul>
                                            <li>
                                                <div class="shopping-cart-img">
                                                    <a href="shop-product-right.html"><img alt="Nest" src="{{asset('assets1/images/thumbnail-3.jpg')}}"></a>
                                                </div>
                                            ...
                                            <li>
                                                <div class="shopping-cart-img">
                                                    <a href="shop-product-right.html"><img alt="Nest" src="{{asset('assets1/images/thumbnail-2.jpg')}}"></a>
                                                </div>
                                                <div class="shopping-cart-title">
                               ...
                               @auth
                                ...
                                <div class="header-action-icon-2">
                                    <a href="page-account.html">
                                        <img class="svgInject" alt="Nest" src="{{asset('assets1/fonts/icon-user.svg')}}">
                                    </a>
                ...
                <div class="header-wrap header-space-between position-relative">
                        ...
                        <div class="main-categori-wrap d-none d-lg-block">
                            ...
                            <div class="categories-dropdown-wrap categories-dropdown-active-large font-heading">
                                <div class="d-flex categori-dropdown-inner">
                                    <ul>
                                        <li>
                                            <a href="shop-grid-right.html"> <img src="{{asset('assets1/fonts/category-1.svg')}}" alt>Milks and Dairies</a>
                                        </li>
                                        <li>
                                            <a href="shop-grid-right.html"> <img src="{{asset('assets1/fonts/category-2.svg')}}" alt>Clothing & beauty</a>
                                        </li>
                                        <li>
                                            <a href="shop-grid-right.html"> <img src="{{asset('assets1/fonts/category-3.svg')}}" alt>Pet Foods & Toy</a>
                                        </li>
                                        <li>
                                            <a href="shop-grid-right.html"> <img src="{{asset('assets1/fonts/category-4.svg')}}" alt>Baking material</a>
                                        </li>
                                        <li>
                                            <a href="shop-grid-right.html"> <img src="{{asset('assets1/fonts/category-5.svg')}}" alt>Fresh Fruit</a>
                                        </li>
                                    </ul>
                                    <ul class="end">
                                        <li>
                                            <a href="shop-grid-right.html"> <img src="{{asset('assets1/fonts/category-6.svg')}}" alt>Wines & Drinks</a>
                                        </li>
                                        <li>
                                            <a href="shop-grid-right.html"> <img src="{{asset('assets1/fonts/category-7.svg')}}" alt>Fresh Seafood</a>
                                        </li>
                                        <li>
                                            <a href="shop-grid-right.html"> <img src="{{asset('assets1/fonts/category-8.svg')}}" alt>Fast food</a>
                                        </li>
                                        <li>
                                            <a href="shop-grid-right.html"> <img src="{{asset('assets1/fonts/category-9.svg')}}" alt>Vegetables</a>
                                        </li>
                                        <li>
                                            <a href="shop-grid-right.html"> <img src="{{asset('assets1/fonts/category-10.svg')}}" alt>Bread and Juice</a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="more_slide_open" style="display: none">
                                    <div class="d-flex categori-dropdown-inner">
                                        <ul>
                                            <li>
                                                <a href="shop-grid-right.html"> <img src="{{asset('assets1/fonts/icon-1.svg')}}" alt>Milks and Dairies</a>
                                            </li>
                                            <li>
                                                <a href="shop-grid-right.html"> <img src="{{asset('assets1/fonts/icon-2.svg')}}" alt>Clothing & beauty</a>
                                            </li>
                                        </ul>
                                        <ul class="end">
                                            <li>
                                                <a href="shop-grid-right.html"> <img src="{{asset('assets1/fonts/icon-3.svg')}}" alt>Wines & Drinks</a>
                                            </li>
                                            <li>
                                                <a href="shop-grid-right.html"> <img src="{{asset('assets1/fonts/icon-4.svg')}}" alt>Fresh Seafood</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <nav>
                                <ul>
                                        ...
                                        <ul class="mega-menu">
                                            ...
                                            <li class="sub-mega-menu sub-mega-menu-width-34">
                                                <div class="menu-banner-wrap">
                                                    <a href="shop-product-right.html"><img src="{{asset('assets1/images/banner-menu.png')}}" alt="Nest"></a>
                                    ...
                                    <li>
                                        ...
                                        <ul class="sub-menu account-dropdown">
                                            <li>
                                                <a href="page-account.html"><i class="fi fi-rs-user mr-10"></i>My Account</a>
                                            </li>
                                            <li>
                                    ...
                                    <li>
                                        <a href="" class="btn btn-xs btn-shop-now">Shop Now <i class="fi-rs-arrow-small-right"></i></a>
                                    </li>
                                </ul>
                            </nav>
                        </div>
                    ...
                    <div class="header-action-right d-block d-lg-none">
                        <div class="header-action-2">
                            <div class="header-action-icon-2">
                                <a href="shop-wishlist.html">
                                    <img alt="Nest" src="{{asset('assets1/fonts/icon-heart.svg')}}">
                            ...
                            <div class="header-action-icon-2">
                                ...
                                <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                    <ul>
                                        ...
                                        <li>
                                            <div class="shopping-cart-img">
                                                <a href="shop-product-right.html"><img alt="Nest" src="{{asset('assets1/images/thumbnail-4.jpg')}}"></a>
                                            </div>
                                            <div class="shopping-cart-title">
                ...
                <div class="row">
                    <div class="col-lg-2 d-none d-lg-flex">
                        <div class="categories-dropdown-wrap style-2 font-heading mt-30">
                            <div class="d-flex categori-dropdown-inner">
                                <img src="{{asset('assets1/images/banner-4.png')}}" alt="">
                                {{-- <ul>
                                    <li>
                                        <a href="shop-grid-right.html"> <img src="{{asset('assets1/fonts/category-1.svg')}}" alt>Milks and Dairies</a>
                                    </li>
                            ...
                            <div class="hero-slider-1 style-5 dot-style-1 dot-style-1-position-2">
                                <div class="single-hero-slider single-animation-wrap" style="background-image: url({{asset('assets1/images/black-man-shopping.jpg')}})">
                                    <div class="slider-content">
                                        ...
                                        <p class="mb-65 text-white">Sign up for the daily newsletter</p>
                                ...
                                <div class="single-hero-slider single-animation-wrap" style="background-image: url({{asset('assets1/images/excited-african-woman-holding-shopping-bags-mobile-phone_171337-14029.webp')}})">
                                    <div class="slider-content">
                                        ...
                                        <p class="mb-65 text-white">Save up to 50% off on your first order</p>
                                        {{-- <form class="form-subcriber d-flex">
                                            <input type="email" placeholder="Your emaill address">
                                            <button class="btn" type="submit">Subscribe</button>
                                        </form> --}}
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-12">
                                <div class="banner-img style-4 mt-30">
                                    <img src="{{asset('assets1/images/banner-14.png')}}" alt>
                            ...
                            <div class="col-md-6 col-lg-12">
                                <div class="banner-img style-5 mt-5 mt-md-30">
                                    <img src="{{asset('assets1/images/banner-15.png')}}" alt>
                                    <div class="banner-text">
                                        <h5 class="mb-20">
                                            The best Organic <br>
                                            Products Online
                                    ...
                                    <div class="carausel-4-columns carausel-arrow-center" id="carausel-4-columns">
                                        <div class="mx-2">
                                            <div class="banner-img style-6 wow animate__animated animate__fadeInUp featured-cat-height" data-wow-delay="0">
                                                <img src="{{asset('assets1/images/banner-16.png')}}" alt>
                                                <div class="banner-text">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="banner-img style-6 wow animate__animated animate__fadeInUp" data-wow-delay="0.2s">
                            <img src="{{asset('assets1/images/banner-17.png')}}" alt>
                            <div class="banner-text">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="banner-img style-6 wow animate__animated animate__fadeInUp" data-wow-delay="0.4s">
                            <img src="{{asset('assets1/images/banner-18.png')}}" alt>
                            <div class="banner-text">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="banner-img style-6 wow animate__animated animate__fadeInUp" data-wow-delay="0.6s">
                            <img src="{{asset('assets1/images/banner-19.png')}}" alt>
                            <div class="banner-text">
                        ...
                        <div class="product-cart-wrap style-2 wow animate__animated animate__fadeInUp" data-wow-delay="0">
                            <div class="product-img-action-wrap">
                                <div class="product-img">
                                    <a href="shop-product-right.html">
                                        <img src="{{asset('assets1/images/banner-5.png')}}" alt>
                                    </a>
                                </div>
                            </div>
                            <div class="product-content-wrap">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="product-cart-wrap style-2 wow animate__animated animate__fadeInUp" data-wow-delay=".1s">
                            <div class="product-img-action-wrap">
                                <div class="product-img">
                                    <a href="shop-product-right.html">
                                        <img src="{{asset('assets1/images/banner-6.png')}}" alt>
                                    </a>
                                </div>
                            </div>
                            <div class="product-content-wrap">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 d-none d-lg-block">
                        <div class="product-cart-wrap style-2 wow animate__animated animate__fadeInUp" data-wow-delay=".2s">
                            <div class="product-img-action-wrap">
                                <div class="product-img">
                                    <a href="shop-product-right.html">
                                        <img src="{{asset('assets1/images/banner-7.png')}}" alt>
                                    </a>
                                </div>
                            </div>
                            <div class="product-content-wrap">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 d-none d-xl-block">
                        <div class="product-cart-wrap style-2 wow animate__animated animate__fadeInUp" data-wow-delay=".3s">
                            <div class="product-img-action-wrap">
                                <div class="product-img">
                                    <a href="shop-product-right.html">
                                        <img src="{{asset('assets1/images/banner-8.png')}}" alt>
                                    </a>
                                </div>
                            </div>
                            <div class="product-content-wrap">
                ...
                <div class="row">
                        ...
                        <div class="product-list-small animated animated">
                            <article class="row align-items-center hover-up">
                                <figure class="col-md-4 mb-0">
                                    <a href="shop-product-right.html"><img src="{{asset('assets1/images/thumbnail-1.jpg')}}" alt></a>
                                </figure>
                            ...
                            <article class="row align-items-center hover-up">
                                <figure class="col-md-4 mb-0">
                                    <a href="shop-product-right.html"><img src="{{asset('assets1/images/thumbnail-2.jpg')}}" alt></a>
                                </figure>
                                <div class="col-md-8 mb-0">
                                    <h6>
                                        <a href="shop-product-right.html">Nestle Original Coffee-Mate Coffee Creamer</a>
                            ...
                            <article class="row align-items-center hover-up">
                                <figure class="col-md-4 mb-0">
                                    <a href="shop-product-right.html"><img src="{{asset('assets1/images/thumbnail-3.jpg')}}" alt="dd"></a>
                                </figure>
                                <div class="col-md-8 mb-0">
                                    <h6>
                                        <a href="shop-product-right.html">Nestle Original Coffee-Mate Coffee Creamer</a>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 mb-md-0 wow animate__animated animate__fadeInUp" data-wow-delay=".1s">
                        ...
                        <div class="product-list-small animated animated">
                            <article class="row align-items-center hover-up">
                                <figure class="col-md-4 mb-0">
                                    <a href="shop-product-right.html"><img src="{{asset('assets1/images/thumbnail-4.jpg')}}" alt></a>
                                </figure>
                                <div class="col-md-8 mb-0">
                                    <h6>
                            ...
                            <article class="row align-items-center hover-up">
                                <figure class="col-md-4 mb-0">
                                    <a href="shop-product-right.html"><img src="{{asset('assets1/images/thumbnail-5.jpg')}}" alt></a>
                                </figure>
                                <div class="col-md-8 mb-0">
                                    <h6>
                            ...
                            <article class="row align-items-center hover-up">
                                <figure class="col-md-4 mb-0">
                                    <a href="shop-product-right.html"><img src="{{asset('assets1/images/thumbnail-6.jpg')}}" alt></a>
                                </figure>
                                <div class="col-md-8 mb-0">
                                    <h6>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 mb-sm-5 mb-md-0 d-none d-lg-block wow animate__animated animate__fadeInUp" data-wow-delay=".2s">
                        ...
                        <div class="product-list-small animated animated">
                            <article class="row align-items-center hover-up">
                                <figure class="col-md-4 mb-0">
                                    <a href="shop-product-right.html"><img src="{{asset('assets1/images/thumbnail-7.jpg')}}" alt></a>
                                </figure>
                                <div class="col-md-8 mb-0">
                                    <h6>
                            ...
                            <article class="row align-items-center hover-up">
                                <figure class="col-md-4 mb-0">
                                    <a href="shop-product-right.html"><img src="{{asset('assets1/images/thumbnail-8.jpg')}}" alt></a>
                                </figure>
                                <div class="col-md-8 mb-0">
                                    <h6>
                            ...
                            <article class="row align-items-center hover-up">
                                <figure class="col-md-4 mb-0">
                                    <a href="shop-product-right.html"><img src="{{asset('assets1/images/thumbnail-9.jpg')}}" alt></a>
                                </figure>
                                <div class="col-md-8 mb-0">
                                    <h6>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 mb-sm-5 mb-md-0 d-none d-xl-block wow animate__animated animate__fadeInUp" data-wow-delay=".3s">
                        ...
                        <div class="product-list-small animated animated">
                            <article class="row align-items-center hover-up">
                                <figure class="col-md-4 mb-0">
                                    <a href="shop-product-right.html"><img src="{{asset('assets1/images/thumbnail-10.jpg')}}" alt></a>
                                </figure>
                                <div class="col-md-8 mb-0">
                                    <h6>
                            ...
                            <article class="row align-items-center hover-up">
                                <figure class="col-md-4 mb-0">
                                    <a href="shop-product-right.html"><img src="{{asset('assets1/images/thumbnail-11.jpg')}}" alt></a>
                                </figure>
                                <div class="col-md-8 mb-0">
                                    <h6>
                            ...
                            <article class="row align-items-center hover-up">
                                <figure class="col-md-4 mb-0">
                                    <a href="shop-product-right.html"><img src="{{asset('assets1/images/thumbnail-12.jpg')}}" alt></a>
                                </figure>
                                <div class="col-md-8 mb-0">
                                    <h6>
                    ...
                    <div class="col">
                        <div class="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0 wow animate__animated animate__fadeInUp" data-wow-delay="0">
                            <div class="logo mb-30">
                                <a href="index.html" class="mb-15"><img src="{{asset('assets1/fonts/logo.svg')}}" alt="logo"></a>
                                <p class="font-lg text-heading">Awesome grocery store website template</p>
                            </div>
                            <ul class="contact-infor">
                                <li><img src="{{asset('assets1/fonts/icon-location.svg')}}" alt><strong>Address: </strong> <span>5171 W Campbell Ave undefined Kent, Utah 53127 United States</span></li>
                                <li><img src="{{asset('assets1/fonts/icon-contact.svg')}}" alt><strong>Call Us:</strong><span>(+91) - 540-025-124553</span></li>
                                <li><img src="{{asset('assets1/fonts/icon-email-2.svg')}}" alt><strong>Email:</strong><span><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="c1b2a0ada4818fa4b2b5efa2aeac">[email&#160;protected]</a></span></li>
